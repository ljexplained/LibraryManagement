...
namespace Libms.Report
{
    public class SessionReport
    {
        ...
        public byte[] PrepareSessionReport(List<My_session> mysession)
        {
        ...
        private void ReportHeader()
        {
            ...
            cell = new PdfPCell(new Phrase("Session Report:", font));
            cell.Colspan = _totalColumn;
            cell.HorizontalAlignment = Element.ALIGN_LEFT;
            cell.Border = 0;
            cell.BackgroundColor = BaseColor.WHITE;
        ...
        private void ReportBody()
        {
            ...
            cell = new PdfPCell(new Phrase("Session Name", font));
            cell.HorizontalAlignment = Element.ALIGN_CENTER;
            cell.VerticalAlignment = Element.ALIGN_MIDDLE;
            cell.BackgroundColor = BaseColor.WHITE;
            table.AddCell(cell);
            ...
            int serialNumber = 1;
            foreach (var item in _mysession)
            {

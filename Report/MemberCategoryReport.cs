...
{
    public class MemberCategoryReport
    {
        ...
        List<Member_type> _membertypes = new List<Member_type>();
        #endregion


        public byte[] PrepareMemberCategoryReport(List<Member_type> membertypes)
        {
        ...
        private void ReportHeader()
        {
            ...
            cell = new PdfPCell(new Phrase("Member Type Report:", font));
            cell.Colspan = _totalColumn;
            cell.HorizontalAlignment = Element.ALIGN_LEFT;
            cell.Border = 0;
            cell.BackgroundColor = BaseColor.WHITE;
        ...
        private void ReportBody()
        {
            ...
            cell = new PdfPCell(new Phrase("Member Category  Name", font));
            cell.HorizontalAlignment = Element.ALIGN_CENTER;
            cell.VerticalAlignment = Element.ALIGN_MIDDLE;
            cell.BackgroundColor = BaseColor.WHITE;
            table.AddCell(cell);
            ...
            int serialNumber = 1;
            foreach (var item in _membertypes)
            {
                ...
                cell = new PdfPCell(new Phrase(item.Mttype, font));
                cell.HorizontalAlignment = Element.ALIGN_CENTER;
                cell.VerticalAlignment = Element.ALIGN_MIDDLE;
                cell.BackgroundColor = BaseColor.WHITE;
                table.AddCell(cell);

                cell = new PdfPCell(new Phrase(item.Mtremark, font));
                cell.HorizontalAlignment = Element.ALIGN_CENTER;
                cell.VerticalAlignment = Element.ALIGN_MIDDLE;
                cell.BackgroundColor = BaseColor.WHITE;
                table.AddCell(cell);

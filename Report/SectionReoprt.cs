...
namespace Libms.Report
{
    public class SectionReoprt
    {
        ...
        List<My_section> _mysection = new List<My_section>();
        #endregion


        public byte[] PrepareSectionReport(List<My_section> mysection)
        {
            ...
            document.Open();
            table.SetWidths(new float[] { 50f, 150f, 150f , 150f});
            #endregion
        ...
        private void ReportHeader()
        {
            ...
            cell = new PdfPCell(new Phrase("Section Report:", font));
            cell.Colspan = _totalColumn;
            cell.HorizontalAlignment = Element.ALIGN_LEFT;
            cell.Border = 0;
            cell.BackgroundColor = BaseColor.WHITE;
        ...
        private void ReportBody()
        {
            ...
            cell = new PdfPCell(new Phrase("Section Name", font));
            cell.HorizontalAlignment = Element.ALIGN_CENTER;
            cell.VerticalAlignment = Element.ALIGN_MIDDLE;
            cell.BackgroundColor = BaseColor.WHITE;
            table.AddCell(cell);
            ...
            int serialNumber = 1;
            foreach (var item in _mysection)
            {
                ...
                cell = new PdfPCell(new Phrase(item.SName, font));
                cell.HorizontalAlignment = Element.ALIGN_CENTER;
                cell.VerticalAlignment = Element.ALIGN_MIDDLE;
                cell.BackgroundColor = BaseColor.WHITE;
                table.AddCell(cell);

                cell = new PdfPCell(new Phrase(item.Sremark, font));
                cell.HorizontalAlignment = Element.ALIGN_CENTER;
                cell.VerticalAlignment = Element.ALIGN_MIDDLE;
                cell.BackgroundColor = BaseColor.WHITE;
                table.AddCell(cell);

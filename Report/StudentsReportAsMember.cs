...
{
    public class StudentsReportAsMember
    {
        private readonly IHostingEnvironment _environment;
        PdfWriter _pdfWriter;
        public StudentsReportAsMember(IHostingEnvironment environment)
        {
            //_logger = logger;
        ...
        public byte[] PrepareStudentsReportAsMember()
        {
            ...
            table.SetWidths(new float[] { 80f, 80f,80f, 120f, 120f, 120f });
            #endregion
        ...
        private void ReportBody()
        {
            ...
            cell = new PdfPCell(new Phrase("1.Student Name\n2.Class\n3.Year", font));
            //cell.Colspan = _totalColumn;
            cell.HorizontalAlignment = Element.ALIGN_CENTER;
            //cell.Border = 0;
            cell.BackgroundColor = BaseColor.WHITE;
            ...
            font = FontFactory.GetFont("Arial", 9f, 0);
            cell = new PdfPCell(new Phrase("Fathers's Name", font));
            //cell.Colspan = _totalColumn;
            cell.HorizontalAlignment = Element.ALIGN_CENTER;
            //cell.Border = 0;
            cell.BackgroundColor = BaseColor.WHITE;
            ...
            font = FontFactory.GetFont("Arial", 9f, 0);
            cell = new PdfPCell(new Phrase("Phone No", font));
            //cell.Colspan = _totalColumn;
            cell.HorizontalAlignment = Element.ALIGN_CENTER;
            //cell.Border = 0;
            cell.BackgroundColor = BaseColor.WHITE;
            ...
            font = FontFactory.GetFont("Arial", 9f, 0);
            cell = new PdfPCell(new Phrase("Qr code", font));
            //cell.Colspan = _totalColumn;
            cell.HorizontalAlignment = Element.ALIGN_CENTER;
            //cell.Border = 0;
            cell.BackgroundColor = BaseColor.WHITE;
            ...
            while (reader.Read())
            {
                ...
                //string qrcodeinfo = reader.GetString(1)+","+reader.GetString(3);
                string filepath = "";
                ...
                font = FontFactory.GetFont("Arial", 9f, 0);
                cell = new PdfPCell(new Phrase(reader.GetString(6), font));
                cell.HorizontalAlignment = Element.ALIGN_CENTER;
                cell.VerticalAlignment = Element.ALIGN_MIDDLE;
                cell.BackgroundColor = BaseColor.WHITE;
                cell.ExtraParagraphSpace = 4;
                ...
                font = FontFactory.GetFont("Arial", 9f, 0);
                cell = new PdfPCell(new Phrase(reader.GetString(7), font));
                cell.HorizontalAlignment = Element.ALIGN_CENTER;
                cell.VerticalAlignment = Element.ALIGN_MIDDLE;
                cell.BackgroundColor = BaseColor.WHITE;
                cell.ExtraParagraphSpace = 4;

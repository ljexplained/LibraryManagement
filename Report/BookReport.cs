...
namespace Libms.Report
{
    public class BookReport
    {
        ...
        public byte[] PrepareBookReport(List<Mybooks> books)
        {
            ...
            table.SetWidths(new float[] { 50f, 100f, 100f, 100f, 100f,
                100f, 100f, 100f, 100f, 100f, 100f, 100f
                //, 50f, 50f,
        ...
        private void ReportHeader()
        {
            ...
            cell = new PdfPCell(new Phrase("Book Report:", font));
            cell.Colspan = _totalColumn;
            cell.HorizontalAlignment = Element.ALIGN_LEFT;
            cell.Border = 0;
            cell.BackgroundColor = BaseColor.WHITE;
        ...
        private void ReportBody()
        {
            ...
            //cell = new PdfPCell(new Phrase("Purchase Date", font));
            //cell.HorizontalAlignment = Element.ALIGN_CENTER;
            //cell.VerticalAlignment = Element.ALIGN_MIDDLE;
            //cell.BackgroundColor = BaseColor.WHITE;
            //table.AddCell(cell);
            ...
            foreach (var _mybooks in _books)
            {
                ...
                cell = new PdfPCell(new Phrase(_mybooks.Bprice, font));
                cell.HorizontalAlignment = Element.ALIGN_CENTER;
                cell.VerticalAlignment = Element.ALIGN_MIDDLE;
                cell.BackgroundColor = BaseColor.WHITE;
                table.AddCell(cell);
